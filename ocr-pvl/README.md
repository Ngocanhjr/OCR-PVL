...
| `page_markers.py` | Chuẩn hóa page marker RAG: dùng `<!-- page: n -->`, không dùng heading `## Trang n` |
...
- Thêm script `normalize_existing_markdown.py` để làm sạch lại file `.md` đã xuất mà không cần OCR lại.
